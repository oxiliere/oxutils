...
class TestUpdateTenantUtils(TestCase):
    ...
    @pytest.mark.skipif(
        True, reason="update_tenant requires cacheops which is not available in test environment"
    )
...
class TestCreateTenantSchema(TestCase):
    ...
    @pytest.mark.skipif(
        True, reason="schemas module requires ninja which is not available in test environment"
    )
...
class TestTenantCaches(TestCase):
    ...
    @pytest.mark.skipif(
        True, reason="caches module requires cacheops which is not available in test environment"
    )
...
class TestSetupController(TestCase):
    ...
    @pytest.mark.skipif(
        True,
        reason="controllers module requires ninja_extra which is not available in test environment",
    )
