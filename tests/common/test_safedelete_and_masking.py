...
class TestGetFieldMaskingFernet:
    ...
    @override_settings(
        FIELD_MASKING_CRYPTO_ENABLED=True,
...
class TestSafeDeleteModelMixin(TestCase):
    ...
    def test_restore_masked_fields(self, mock_save):
        ...
        instance = self.TestModel(email="masked@invalid.local", username="masked-user")
        instance.pk = 1
        instance._masked_backup = {"email": "original@example.com", "username": "originaluser"}
    ...
    def test_restore_masked_fields_with_collision(self):
        ...
        instance = self.TestModel(email="masked@invalid.local")
        instance.pk = 1
        instance._masked_backup = {"email": "original@example.com"}
