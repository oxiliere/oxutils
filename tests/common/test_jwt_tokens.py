...
from oxutils.jwt.tokens import OrganizationAccessToken, OxilierServiceToken
...
class TestOxilierServiceToken:
    ...
    def test_service_token_with_payload(self):
        ...
        custom_payload = {"service_name": "auth-service", "permissions": ["read", "write"]}
...
class TestTokenIntegration:
    ...
    def test_service_token_roundtrip(self):
        ...
        payload = {"service": "api-gateway", "version": "1.0"}
